...
const audiences = [
  { icon: Plane, text: 'Leisure & business travelers' },
  { icon: Users, text: 'Families & senior citizens' },
  { icon: GraduationCap, text: 'Students & solo travelers' },
  { icon: Briefcase, text: 'Long stays, relocations & vacations' },
];
