...
export default function StickyStepsOverlap() {
  const steps = [
    {
      step: "STEP 1",
      title: "Dedicated Pickup Agent",
      desc: "YNo batch pickups. One agent. One shipment.",
      icon: "📦",
    },
    {
      step: "STEP 2",
      title: "White-Glove Handling",
      desc: "Careful handling, manual loading, and secure packaging.",
      icon: "📡",
    },
    {
      step: "STEP 3",
      title: "Fastest Transit Priority",
      desc: "Your shipment moves first—always.",
      icon: "🚢",
    },

    {
      ...
      desc: "Comprehensive insurance coverage included.",
      icon: "🚢",
    },
    {
      step: "STEP 5",
      title: "Live GPS Tracking",
      desc: "Real-time location with advanced tracking visibility.",
      icon: "🚢",
    },
    {
      step: "STEP 6",
      title: "Dedicated Relationship Manager",
      desc: "Single point of contact for updates & support.",
      icon: "🚢",
    },
    {
      step: "STEP 7",
      title: "Priority Billing & Documentation",
      desc: "Instant invoices, GST billing & delivery proof.",
      icon: "🚢",
    },
    {
      step: "STEP 8",
      title: "24×7 Priority Support",
      desc: "Round-the-clock assistance for premium customers.",
      icon: "🚢",
    },
  ];
